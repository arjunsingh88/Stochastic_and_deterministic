function[] = ex11_FULLPATH(epsilon,r0)

X_cord=[-2 -5 -3 0 2 4 5];
Y_cord=[2 10 -3 0 3 10 -10];
T = [1 1 1 1 1 1 1];

for i=1:length(X_cord)
    [~,~,x,y] = ex11([X_cord(i),Y_cord(i)],0.001,T(i));
    plot(x,y,'-o');
    hold on
end    
xlabel('X');
...
title('Convergence of the Quasi Newton algorithm optimal for Himmelblow with Wolfe Step')
set(gca,'Color',[1 0 0])
set(gca,'Color',[1 1 1])
